 ...
 */
final class Version20240715172542 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE users DROP created_by_id, DROP updated_by_id, DROP fullname, DROP created_at, DROP updated_at, DROP slug');
    }
}
